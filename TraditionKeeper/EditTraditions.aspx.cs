...
{
	public partial class EditTraditions : System.Web.UI.Page
	{
		...
		protected void btnEditTraditionsExit_Click(object sender, EventArgs e)
		{
		...
		{
			SqlDataSource1.InsertParameters["TRAD_Name"].DefaultValue = ((TextBox)GridView1.FooterRow.FindControl("txtInsertTradName")).Text;
			SqlDataSource1.InsertParameters["TRAD_Description"].DefaultValue = ((TextBox)GridView1.FooterRow.FindControl("txtInsertTradDescription")).Text;
			SqlDataSource1.InsertParameters["TRAD_Category"].DefaultValue = ((TextBox)GridView1.FooterRow.FindControl("txtInsertTradCategory")).Text;
