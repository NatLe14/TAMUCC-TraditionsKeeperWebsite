...
{
	public partial class EditBuildings : System.Web.UI.Page
	{
		...
		protected void btnEditBuildingsExit_Click(object sender, EventArgs e)
		{
		...
		{
			SqlDataSource1.InsertParameters["BILD_Name"].DefaultValue = ((TextBox)GridView1.FooterRow.FindControl("txtInsertBuildingName")).Text;
			SqlDataSource1.InsertParameters["BILD_Description"].DefaultValue = ((TextBox)GridView1.FooterRow.FindControl("txtInsertBuildingDescription")).Text;
			SqlDataSource1.InsertParameters["BILD_Year"].DefaultValue = ((TextBox)GridView1.FooterRow.FindControl("txtInsertBuildingYear")).Text;
